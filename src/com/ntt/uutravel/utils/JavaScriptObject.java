...
public class JavaScriptObject {
	...
	Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 1:
				showShareSDK(msg.getData().getString("title"), msg.getData().getString("content"), msg.getData().getString("imgUrl"), msg.getData().getString("linkUrl"));
				break;
			}
		}  
	};   
	...
	private void showShareSDK(String title,String content,String imgUrl,String linkUrl) {
        ...
        oks.setCallback(new PlatformActionListener(){
			...
			public void onError(Platform arg0, int arg1, Throwable arg2) {
				// TODO Auto-generated method stub
				showToast(arg2.getMessage(),"CENTER");
			}
        });
        // 启动分享GUI
